...
public class StringUtil extends org.apache.commons.lang3.StringUtils {
	...
	public static final int ENCODE_MD5_RETURN_LENGTH16 = 16;
	public static final int ENCODE_MD5_RETURN_LENGTH32 = 32;
	...
	public static String linkedHashMapToString(LinkedHashMap<String, String> map) {
		if (map != null && map.size() > 0) {
			...
			for (String name : map.keySet()) {
				...
				result.append(("".equals(result.toString())) ? "" : "&");
	...
	public static String moneyToString(Object money, String style) {
		if (style != null && (money instanceof Double || money instanceof Float)) {
			assert money instanceof Double;
	...
	public static String[] getStringArrayByPattern(String str, String pattern) {
		...
		// 范型
		Set<String> result = new HashSet<>();// 目的是：相同的字符串只返回一个。。。 不重复元素
